...
public class TestCustomDishDAO {
    ...
    public static Collection data(){
        return Arrays.asList( new Object[][]{
                        {
                            new CustomDish("NewCustomDish5"),
                            new Nutrients(122.1, 321.1, 432.1),
                            new DishType("newDishType6"),
                            new User.Builder().withName("Alex").withSurname("Volkov").withEmail("email12@gmail.com")
                                        .withLifestyle(Lifestyle.ACTIVE).withWeight(87.0).withHeight(187.2).withPassword("root")
                                        .withUsername("my_username12").withSex(Sex.MALE).withAge(19).build()
